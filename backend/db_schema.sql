...
VALUES 
('sean@mail.com', 'sean', '123', 4, 'Sean is a seasoned professional with extensive experience in finance and investment banking. He enjoys mentoring young professionals and contributing to financial forums.', 'Grenoble Ecole de Management, MSc Finance and Investment Banking (Top-up)'),
('matthew@mail.com', 'matthew', '123', 4, 'Matthew is passionate about digital media and enjoys working on creative projects. He has a keen interest in developing innovative marketing strategies for digital platforms.', 'University of Stirling, Bachelor of Arts Digital Media (Top-up)'),
('tyler@mail.com', 'tyler', '123', 5, 'Tyler is an aspiring game developer with a strong foundation in computer science. He is particularly interested in the fields of AI and machine learning within game design.', 'University of Wollongong, Bachelor of Computer Science (Game and Mobile Development)'),
('emily@mail.com', 'emily', '123', 3, 'Emily is an emerging leader in event management with a background in business. She is driven by her passion for creating memorable experiences through well-organized events.', 'La Trobe University, Bachelor of Business (Event Management) (Top-up)'),
('lily@mail.com', 'lily', '123', 4, 'Lily is a business professional with expertise in tourism and hospitality. She loves exploring different cultures and integrating them into her work to create unique customer experiences.', 'La Trobe University, Bachelor of Business (Tourism and Hospitality) (Top-up)'),
('michael@mail.com', 'michael', '123', 5, 'Michael is a dedicated nursing professional who values compassionate care and patient advocacy. He aims to advance his career by exploring innovative healthcare practices.', 'The University of Sydney, Bachelor of Nursing (Post-Registration)');
